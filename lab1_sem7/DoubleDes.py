...
class DoubleDes:
    ...
    def encrypt_and_decrypt(self, data, output=False):
        ...
        enc2 = self.des.encrypt(enc1, string_to_bin_list(self.KEY2))

        dec1 = self.des.decrypt(enc2, string_to_bin_list(self.KEY2))
        dec2 = self.des.decrypt(dec1, string_to_bin_list(self.KEY1))
        ...
        if output:
            ...
            print(
                'Encoded data with KEY2 after encoding with KEY1' +
                COLOR.HEADER +
